...
const initialStores = [
  {
    ...
    name: "TIGSBD",
    slug: "tigsbd",
    description: "TIGSBD general marketplace catalog",
    logo: "TIGSBD",
  ...
  },
  {
    ...
    name: "Sarongo",
    slug: "sarongo",
    description: "Sarongo women and children catalog",
    logo: "SARONGO",
...
async function seed() {
  ...
  const catalogProducts = [
    { id: "prod_tigsbd_linen-tray", storeId: "store_tigsbd", sku: "TIG-HOME-001", name: "Linen Catchall Tray", slug: "linen-catchall-tray", shortDescription: "A soft-edged landing place for the small essentials.", description: "Made for keys, glasses, and the quiet ritual of arriving home, this linen-lined tray keeps daily objects gathered without making a scene.", priceCents: 42000, salePriceCents: null, featured: true, categoryId: "cat_tigsbd_home", accent: "#e7a83e" },
    { id: "prod_tigsbd_carry-notebook", storeId: "store_tigsbd", sku: "TIG-DAILY-002", name: "Field Notes Journal", slug: "field-notes-journal", shortDescription: "A substantial notebook for plans, lists, and loose thoughts.", description: "A tactile, thread-bound journal with generous pages for the things worth keeping close.", priceCents: 26000, salePriceCents: 22000, featured: false, categoryId: "cat_tigsbd_daily", accent: "#9b8061" },
    { id: "prod_tigsbd_ceramic-mug", storeId: "store_tigsbd", sku: "TIG-HOME-003", name: "Morning Ceramic Mug", slug: "morning-ceramic-mug", shortDescription: "A balanced stoneware mug with a warm satin glaze.", description: "Comfortable in the hand and generous enough for a long morning, finished in a restrained clay tone.", priceCents: 34000, salePriceCents: null, featured: true, categoryId: "cat_tigsbd_home", accent: "#c88963" },
    { id: "prod_sarongo_brass-vessel", storeId: "store_sarongo", sku: "SAR-OBJ-001", name: "Brass Line Vessel", slug: "brass-line-vessel", shortDescription: "A sculptural vessel for a single stem or an empty shelf.", description: "The Brass Line Vessel brings a little considered weight to a room, with a hand-finished profile that catches changing light.", priceCents: 68000, salePriceCents: null, featured: true, categoryId: "cat_sarongo_objects", accent: "#d97852" },
    { id: "prod_sarongo_woven-throw", storeId: "store_sarongo", sku: "SAR-SOFT-002", name: "Woven Ochre Throw", slug: "woven-ochre-throw", shortDescription: "A generous layer in textured cotton with an ochre edge.", description: "Light enough for a chair and warm enough for a late evening, woven with a quietly irregular texture.", priceCents: 84000, salePriceCents: 72000, featured: true, categoryId: "cat_sarongo_textiles", accent: "#b78e4b" },
    { id: "prod_sarongo-glass-candle", storeId: "store_sarongo", sku: "SAR-OBJ-003", name: "Amber Glass Candle", slug: "amber-glass-candle", shortDescription: "A low glow with notes of cedar, fig, and warm paper.", description: "Poured into amber glass and designed to stay in the room after the flame is gone.", priceCents: 38000, salePriceCents: null, featured: false, categoryId: "cat_sarongo_objects", accent: "#aa6d46" },
  ];
  ...
  await db.insert(productVariants).values([
    ...
    { id: "variant_sarongo_throw_large", productId: "prod_sarongo_woven-throw", name: "Large", sku: "SAR-SOFT-002-L", priceCents: 84000, options: { size: "Large" }, status: "active", createdAt: now, updatedAt: now },
  ]).onConflictDoNothing();
